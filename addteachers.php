...
<div align="center" style="margin-top:80px; overflow-x:auto;">
...
<div align="center" style="margin-top:20px; overflow-x:auto;">
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content" style="margin-top: -60px; overflow-x:auto;">
                ...
                <form action="addteacherFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="designation" name="TD">
                            ...
                            <option value="Assistant Professor">Principal</option>
                            <option value="Associate Professor">Teacher</option>
