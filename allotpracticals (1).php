...
<!--NAVBAR SECTION END-->
<br>
<form action="allotmentpracticalFormvalidation.php" method="post" style="margin-top: 100px; overflow-x:auto;">
    <div align="center">
    ...
    <div align="center" style="margin-top: 5px; overflow-x:auto;">
    ...
    <div align="center" style="margin-top: 10px; overflow-x:auto;">
...
<table id=allotedpracticalstable>
    ...
    while ($row = mysqli_fetch_assoc($q)) {
        ...
        $t1 = mysqli_query(mysqli_connect("sql107.epizy.com", "epiz_30859803", "aSf8C7EAurB2rs", "epiz_30859803_ttms"),
            "SELECT name FROM teachers WHERE faculty_number = '$teacher_id1'");
        $trow1 = mysqli_fetch_assoc($t1);
        $t2 = mysqli_query(mysqli_connect("sql107.epizy.com", "epiz_30859803", "aSf8C7EAurB2rs", "epiz_30859803_ttms"),
            "SELECT name FROM teachers WHERE faculty_number = '$teacher_id2'");
        $trow2 = mysqli_fetch_assoc($t2);
        $t3 = mysqli_query(mysqli_connect("sql107.epizy.com", "epiz_30859803", "aSf8C7EAurB2rs", "epiz_30859803_ttms"),
