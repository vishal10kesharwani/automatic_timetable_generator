...
<br>
<div align="center">
    <form action="allotmentFormvalidation.php" method="post" style="margin-top: 100px; overflow-x:auto;">
...
<table id=allotedsubjectstable>
    ...
    while ($row = mysqli_fetch_assoc($q)) {
        ...
        $t = mysqli_query(mysqli_connect("sql107.epizy.com", "epiz_30859803", "aSf8C7EAurB2rs", "epiz_30859803_ttms"),
